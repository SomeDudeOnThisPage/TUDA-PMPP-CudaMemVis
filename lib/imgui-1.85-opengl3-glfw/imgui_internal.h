...
enum ImGuiItemFlags_
{
    ...
    ImGuiItemFlags_NoNavDefaultFocus        = 1 << 4,  // false     // Disable item being a candidate for default focus (e.g. used by m_title bar items)
...
struct IMGUI_API ImGuiWindow
{
    ...
    float                   WindowRounding;                     // Window rounding at the time of Begin(). May be clamped lower to avoid rendering artifacts with m_title bar, menu bar etc.
